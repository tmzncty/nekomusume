...
- [ ] NAT / endpoint change（exact `c81fa73` candidate evidence superseded by EPREB-006/007 barrier review; rerun only after repair）
...
Current classification: NAT/source-endpoint change is `BLOCKED_IMPLEMENTATION` pending EPREB-006/007 authenticated promotion barrier repair; exact `c81fa73` is superseded candidate evidence only. Live PMTUD is `BLOCKED_IMPLEMENTATION`; migration-back is `ALREADY_SUFFICIENT_FOR_BOUNDED_QUESTION`
