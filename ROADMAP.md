...
- [x] bounded authenticated NAT / endpoint source-port change observation（exact `c81fa73`; same-Session source-port change only; general NAT/public reachability remains blocked）
