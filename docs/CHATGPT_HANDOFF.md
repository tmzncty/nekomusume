...
- **H-I4-085 is CLOSED** at exact `38379b1f6a1b76118ecc2c5ee3d64daf4a2a6985` provenance: `docs/notes/h-i4-085-provenance-38379b1-20260921.md` — `PYTHONDONTWRITEBYTECODE=1 bash scripts/check.sh` exit 0 (re-run after transient READY-timeout flake), `git diff --check` exit 0, clean worktree, 2026-09-20T19:50:16Z → 20:02:30Z, Linux x86_64, rustc 1.98.0. The substantive evidence truth was repaired at `250c4d2` + `97e282d`.
