...
| Operator readiness/shutdown/cleanup | [`docs/status.md`](status.md), [`crates/neko-cli/tests/probe.rs`](../crates/neko-cli/tests/probe.rs), [`scripts/bench/owned-lab-control-plane.sh`](../scripts/bench/owned-lab-control-plane.sh) | Local deterministic tests cover `READY -> DRAINING -> STOPPED` and same-address TCP/UDP rebind; installed-package VPS signal/restart evidence remains open; live production service remains out of scope |
