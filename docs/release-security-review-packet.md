...
| Pre-auth/resource limits | [`docs/reviews/resource-abuse-evidence-2026-09-04.md`](reviews/resource-abuse-evidence-2026-09-04.md), [`docs/adr/m1-g0-preauth-resource-budget.md`](adr/m1-g0-preauth-resource-budget.md), [`crates/neko-crypto/src/lib.rs`](../crates/neko-crypto/src/lib.rs), [`crates/neko-cli/src/preauth.rs`](../crates/neko-cli/src/preauth.rs) | Per-state anti-amplification and process-owned source/global accounting are integrated across bounded server listener paths; RSEC-001 now records missing independent review/adversarial load evidence and blocks release/security/public-listener promotion |
