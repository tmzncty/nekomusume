...
def main():
    ...
    result = {
        ...
        "cleanup": {"process_reaped": True, "process_group_empty": group_empty, "owned_sockets_after_exit": owned_sockets_after_exit, "complete": cleanup_complete, "scope": "sampler-created process group"},
    }
